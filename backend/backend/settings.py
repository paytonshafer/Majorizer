...
#super user info(also the admin): U:admin, P:majorizer
#student and advisor passwors will ALL be: majorizer
...
SECRET_KEY = 'django-insecure-v&d=p256b0kw3-w&d%n0xwka8nlbh5dpbuyi9+gusz-)8ad0=*'
